...
```sh
bin/rake db:works:import MEMBER=4374 FROM_UPDATE_DATE=2014 UNTIL_UPDATE_DATE=2014-12
```
...
Deletes works and associated rows in the traces table. Use `MEMBER` to delete works from a particular publisher, or `MEMBER=all" to delete all works.
