  ...
  context "get_data" do
    ...
    context "parse_data" do
      ...
      it "should report if there are no events and event_count returned by the Scopus API" do
        ...
        expect(response).to eq(events: [], extra: {"@force-array"=>"true", "error"=>"Result set was empty"}, :events_by_day=>[], :events_by_month=>[], :events_url=>nil, :event_count=>0, :event_metrics=>{:pdf=>nil, :html=>nil, :shares=>nil, :groups=>nil, :comments=>nil, :likes=>nil, :citations=>0, :total=>0})
      end
