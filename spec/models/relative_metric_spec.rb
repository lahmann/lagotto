...
describe RelativeMetric, type: :model, vcr: true do
  ...
  context "parse_data" do
    let(:null_response) { { events: [], extra: { start_date: "2009-01-01T00:00:00Z", end_date: "2009-12-31T00:00:00Z", subject_areas: [] }, events_by_day: [], events_by_month: [], events_url: nil, event_count: 0, event_metrics: {:pdf=>nil, :html=>nil, :shares=>nil, :groups=>nil, :comments=>nil, :likes=>nil, :citations=>nil, :total=>0} } }
