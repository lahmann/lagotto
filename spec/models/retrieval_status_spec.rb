...
describe RetrievalStatus, type: :model, vcr: true do
  ...
  describe "retrieval_histories" do
    ...
    it "should get past events by month" do
      expect(retrieval_status.get_past_events_by_month).to eq([{:year=>2013, :month=>4, :total=>780}, {:year=>2013, :month=>5, :total=>820}, {:year=>2013, :month=>6, :total=>870}, {:year=>2013, :month=>7, :total=>910}, {:year=>2013, :month=>8, :total=>950}])
    end
  end
end
